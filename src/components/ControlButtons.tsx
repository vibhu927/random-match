...
const ControlButtons: React.FC<ControlButtonsProps> = ({
  ...
  return (
    <div className="flex items-center justify-center gap-4 sm:gap-6 p-3 sm:p-4 flex-wrap">
      <button
        onClick={onToggleMute}
        className={cn(
          'p-3 sm:p-4 rounded-lg transition-all shadow-lg',
          isMuted
      ...
      {isConnected && (
        <button
          onClick={onSkip}
          className="bg-yellow-600 hover:bg-yellow-700 text-white p-3 sm:p-4 rounded-lg transition-all shadow-lg"
